  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="relative">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-white p-6 md:p-10 rounded-sm border border-hudc-light/20 shadow-sm">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-hudc-light/60" />
                <input 
                  type="text" 
